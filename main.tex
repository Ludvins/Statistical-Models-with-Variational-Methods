...
%
%  Autor de la plantilla: Mario Román.
%  Licencia: GNU GPLv2.
%
...
\documentclass[twoside,openright,titlepage,numbers=noenddot,openany,headinclude,footinclude=true,
  cleardoublepage=empty,abstractoff,BCOR=5mm,paper=a4,fontsize=11pt]{scrreprt}
...
\input{sections/BasicConcepts/probability}

\chapter{Distributions}

\input{sections/BasicConcepts/distributions}

\chapter{Graph Theory}

\input{sections/BasicConcepts/graph-theory}
...
\input{sections/GraphicalModels/bayesian-networks}

\chapter{Markov Random Fields}

\input{sections/GraphicalModels/markov-networks}
...
\input{sections/BayesianNetworksLearning/intro}

\chapter{Maximum Likelihood Training}

\input{sections/BayesianNetworksLearning/maximum-likelihood}

\chapter{Bayesian Training}

\input{sections/BayesianNetworksLearning/bayesian}

\chapter{Structure Learning}

\input{sections/BayesianNetworksLearning/structure-learning}

\chapter{Learning With Missing Variables and Data}

\input{sections/BayesianNetworksLearning/missing-variables-and-data}

\section{Expectation Maximization}

\input{sections/BayesianNetworksLearning/expectation-maximization}

\section{Variational Bayes}

\input{sections/BayesianNetworksLearning/variational-bayes}
