...
\input{sections/bayesian-networks}

\chapter{Markov Random Fields}

\input{sections/markov-networks}
...
\input{sections/learning-bn.intro}

\chapter{Maximum Likelihood Training}

\input{sections/learning-bn.maximum-likelihood}

\chapter{Bayesian Training}

\input{sections/learning-bn.bayesian}

\chapter{Structure Learning}

\input{sections/learning-bn.structure}

\chapter{Learning With Missing Variables and Data}

\input{sections/learning-bn.missing-variables-and-data}
